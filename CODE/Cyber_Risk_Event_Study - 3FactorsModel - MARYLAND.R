...
#save.image(file = paste0(folder,  "OUTPUT/results_before_means_CYBER_MARYLAND_2017_2024_spill.RData"))
save.image(file = paste0(folder,  "OUTPUT/results_before_means_CYBER_MARYLAND_2017_2024_sab_dom.RData"))
#save.image(file = paste0(folder,  "OUTPUT/results_before_means_CYBER_MARYLAND_2017_2024_sab_dom_3pre.RData"))

load(paste0(folder,  "OUTPUT/results_before_means_CYBER_MARYLAND_2017_2024_sab_dom.RData"))
################################################################################
### OUTPUT #####################################################################
################################################################################
...
ggarrange(a,b,c,
          labels = c("All", ">1 Billion size firms", "Exploitive attacks"),
          ncol = 3, nrow = 1)
